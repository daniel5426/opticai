...
export function getCoverTestExamByLayoutInstanceId(layoutInstanceId: number, cardInstanceId?: string) {
  return connectionManager.getCoverTestExamByLayoutInstanceId(layoutInstanceId, cardInstanceId  );
}
