  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-6 bottom-0 z-10 hidden h-[calc(100vh-1.5rem)] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
