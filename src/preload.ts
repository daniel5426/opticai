...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  softOpticExport: (payload: { candidate: any; sqlAnywhereBin?: string; includeDocuments?: boolean; clientImportLimit?: number | null }) => ipcRenderer.invoke('softoptic-export', payload),
  softOpticStartExport: (payload: { clinicId?: number; candidate: any; sqlAnywhereBin?: string; includeDocuments?: boolean; clientImportLimit?: number | null }) => ipcRenderer.invoke('softoptic-start-export', payload),
  ...
  migrationStartFullScan: (payload: { sourceSystem: "optitech" }) => ipcRenderer.invoke('migration-start-full-scan', payload),
  migrationFullScanStatus: (payload: { jobId: string }) => ipcRenderer.invoke('migration-full-scan-status', payload),
  migrationCancelFullScan: (payload: { jobId: string }) => ipcRenderer.invoke('migration-cancel-full-scan', payload),
