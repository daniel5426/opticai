...
- [`backend_architecture_current.md`](/Users/danielbenassaya/Code/personal/opticai/docs/design-docs/backend_architecture_current.md)
...
- Release sequencing lives under `exec-plans/active/`, not here.
