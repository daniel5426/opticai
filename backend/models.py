...
Index('ix_orders_clinic_date_id_paging', Order.clinic_id, Order.order_date.desc(), Order.id.desc())
Index('ix_orders_clinic_date_analytics', Order.clinic_id, Order.order_date, postgresql_include=['id', 'type'])
...
Index('ix_contact_lens_orders_clinic_date_id_paging', ContactLensOrder.clinic_id, ContactLensOrder.order_date.desc(), ContactLensOrder.id.desc())
Index('ix_contact_lens_orders_clinic_date_analytics', ContactLensOrder.clinic_id, ContactLensOrder.order_date, postgresql_include=['id', 'type'])
...
Index('ix_billings_order_id', Billing.order_id)
Index('ix_billings_contact_lens_id', Billing.contact_lens_id)
Index('ix_order_line_item_billings_id', OrderLineItem.billings_id)
