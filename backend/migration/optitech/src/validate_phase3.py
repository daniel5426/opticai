...
DEFAULT_REPORT_DIR = WORKSPACE_ROOT / "artifacts" / "reports" / "phase3"
...
def write_phase3_reports(
    *,
    ...
    return {
        ...
        "unresolved_dependencies": write_json_report(
            report_dir / "unresolved_dependencies.json",
            unresolved_dependencies,
        ),
        "missing_scans": write_json_report(report_dir / "missing_scans.json", missing_scans),
