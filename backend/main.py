...
app.include_router(softoptic_migration.router, prefix=config.settings.API_V1_STR)
...
app.include_router(trash.router, prefix=config.settings.API_V1_STR)
